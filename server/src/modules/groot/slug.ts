 ...
 *
 * A third verbatim copy of the runestone/edda helpers, and deliberately so:
 * modules may never import each other, and lifting them into `core/` would put
 * one module's URL scheme in the shared kernel where the next document type is
 * then obliged to adopt it. Duplication is the established shape here — Edda
 * copied them from Runestone for the same reason.
 */
...
/** "Deployment Manifest" → "deployment-manifest"; diacritics stripped, ≤48 chars. */
