...
- 🎞 Saga — present a markdown deck fullscreen: `---` splits the slides, keyboard/swipe navigation, presenter notes, +/− text sizing that carries into fullscreen, and a shortcuts overlay; drop a `.md` file (never uploaded, never stored) or open a saved Edda
