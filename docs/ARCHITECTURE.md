...
➡️ **[`.agents/context/architecture.md`](../.agents/context/architecture.md)**
...
- Project layout — [`.agents/context/project-structure.md`](../.agents/context/project-structure.md)
- Tech choices & rationale — [`.agents/context/tech-stack.md`](../.agents/context/tech-stack.md)
